...
${OBJECTDIR}/EnemiesManager.o: EnemiesManager.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/EnemiesManager.o EnemiesManager.cpp

${OBJECTDIR}/ListAvailableRooms.o: ListAvailableRooms.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ListAvailableRooms.o ListAvailableRooms.cpp

${OBJECTDIR}/ListEnemies.o: ListEnemies.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ListEnemies.o ListEnemies.cpp

${OBJECTDIR}/ListRooms.o: ListRooms.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ListRooms.o ListRooms.cpp
